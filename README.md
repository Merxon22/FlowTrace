...
**Q: What is "focus Jump" in the daily report?**  
A: In the hourly recap plot, one "focus jump" is defined as the user doing either:
- Switches between activities of different category
- Enters a short break (inactivity) that is longer than 5 minutes but shorter than 30 minutes
